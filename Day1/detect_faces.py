...
ap.add_argument('-i', '--image', required=True, help='path to inpu image')
ap.add_argument('-p', '--prototxt', required=True, help='path to Caffe "deploy" prototext file')
ap.add_argument('-m', '--model', required=True, help='patho to Caffe pre-trained model')
...
for i in range(0, detections.shape[2]):
    #Extract the confiden (i.e, probability) associated with the prediction
